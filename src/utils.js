function prepareForChecklist() {
    ...
    // счетчик ошибок установлен в 1, чтобы при первом запуске корректно отрабатывал стейт /Checklist/Start/Error 
